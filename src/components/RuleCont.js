...
const ContentZh = () => (
  <>
    <p>即日起我们正式启动节点招募，任何符合入选条件的主体都可以参与节点竞选，本文将详细介绍比原链侧链的节点竞选规则，帮助有志于成为比原链侧链节点的个人和机构更快、更好地了解比原链侧链的节点选举机制。</p>
    <h1>比原链侧链节点招募指引</h1>
    <ol>
      <li>
    ...
    <ul>
      <li>
        ...
        <ul>
          ...
          <li>权利与义务：通过投票参与比原链侧链共识节点选举，并获得分红奖励。</li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul>
          ...
          <li>权利与义务：对比原链侧链网络贡献开发和宣传资源，并获得社区投票。</li>
        </ul>
      </li>
      <li>
        ·	共识节点：
...
const ContentEn = () => (
  <>
    <p>We officially launch the Block Producer recruitment and anyone meets the requirements can participate in the Block Producer election. This paper will introduce the Block Producer election rules of Bytom Sidechain in detail, so as to help individuals and institutions who are willing to be the Block Producer of Bytom Sidechain.</p>
    <h1>Bytom Sidechain Block Producer  recruitment guidance</h1>
    <ol>
      <li>
    ...
    <h1>Bytom Sidechain Block Producer conditions</h1>
    ...
    <ul>
      <li>
        ...
        <ul>
          ...
          <li>Rights and obligations: Participate in Bytom Sidechain Block Producer election by voting and get bonus.</li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul>
          ...
          <li>Rights and obligations: Contribute development and promotion resources to the Bytom Sidechain network and get votes from the community .</li>
        </ul>
      </li>
      <li>
        ·	Block Producer
    ...
    <h1>Bytom Sidechain Block Producer reward</h1>
      <ul>
        <li>
      ...
      <h1>Bytom Sidechain Block Producer recruitment FAQ</h1>
      <ol>
        <li>
        ...
        <li>
          <p>Q: How often does Bytom Sidechain statistic votes and update the ranking?</p>
        ...
        <li>
          <p>Q:  what the recommended configuration of ytom Sidechain is so high?</p>
